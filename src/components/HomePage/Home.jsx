...
export default function Home() {
  return (
    <div className="flex flex-col gap-[24px]">
      {/* 총 자산 */}
      <div className="w-full h-[120px] rounded-[12px] bg-white shadow-[0_0_8px_#E7E9EECC]"></div>

      {/* 자산 분석 */}
      <div className="flex flex-col gap-[12px]">
        <div className="flex justify-between">
          <h1 className="text-gray-100 text-[16px] font-bold">자산 분석</h1>
        ...
        <div className="w-full h-[98px] rounded-[12px] bg-white shadow-[0_0_8px_#E7E9EECC]"></div>
      </div>
