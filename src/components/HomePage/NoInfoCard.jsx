...
export default function NoInfoCard({ description, buttonTitle, to }) {
  return (
    <>
      <div className="flex flex-col gap-[16px] bg-white h-[188px] rounded-[12px] justify-center items-center shadow-[0_0_8px_#E7E9EECC]">
        ...
        <Link
          to={to}
          className="flex gap-[4px] w-[114px] h-[30px] border-[1px] border-gray-5 rounded-[16px] justify-center items-center"
        >
