...
export default function LoginPage() {
  const handleKaKaoLogin = () => {
    window.location.href =
      'https://growplanserver.shop/oauth2/authorization/kakao';
  };

  return (
    <div
      className="h-full flex flex-col items-center gap-y-4 justify-center min-h-screen w-full
    ...
    >
      ...
      >
        ...
        <img
          src={MainLogo}
          alt="App Logo"
          className="w-[100px] object-contain mb-20"
        />
      </motion.div>
